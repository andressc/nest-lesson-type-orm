...
export class FindAllCommentsBlogCommand {
	constructor(public query: QueryBlogDto, public currentUserId?: string) {}
}

@QueryHandler(FindAllCommentsBlogCommand)
export class FindAllCommentsBlogHandler implements IQueryHandler<FindAllCommentsBlogCommand> {
	constructor(
	...
	async execute(command: FindAllCommentsBlogCommand): Promise<PaginationDto<ResponseBlogDto[]>> {
